...
var desc = []
//Array to keep track that this question is answered or not .
var answered = []
...
//function tickAnswer( question_no , optionSelected ){
 //  if(answered[question_no] == false ) answerTicked[question_no] = optionSelected ;
 //  answered[question_no]  =  true ;

//}
function fun(){
    
    localStorage.setItem( 'a' , totalScored ) ;
...
function displayQuestionOption(){
    ...
    for( var i = 0 ; i <= 10 ; i++ )answered[i] = false ;
